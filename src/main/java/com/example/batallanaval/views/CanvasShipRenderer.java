...
/**
 * Implementación de ShipRenderer que utiliza JavaFX Canvas para dibujar
 * diferentes representaciones visuales de barcos.
 * (Portaaviones, Submarino, Destructor, Fragata) basándose en su tamaño.
 * El dibujo se adapta al tamaño del Canvas proporcionado.
 */
public class CanvasShipRenderer implements ShipRenderer {
    /**
     * Dibuja la representación visual de un barco en el Canvas, escalando
     * el dibujo según el tamaño del Canvas.
     * Se aplica una sombra para dar un efecto de profundidad al barco.
     * @param canvas El Canvas donde se dibujará el barco.
     * @param size El tamaño del barco (número de celdas), que determina el tipo de barco a dibujar.
     */
    @Override
    public void render(Canvas canvas, int size) {
        ...
        // Limpiamos el Canvas antes de dibujar el nuevo barco
        gc.clearRect(0, 0, w, h);
        // Sombra para dar profundidad al barco
        gc.setEffect(new DropShadow(10, Color.BLACK));
        double padding = h * 0.1;  // Margen para que el barco no toque los bordes del Canvas
        double shipW = w - (padding * 2);
        double shipH = h - (padding * 2);
        double x = padding;
        double y = padding;
        // Selecciona el método de dibujo basado en el tamaño del barco
        switch (size) {
    ...
    /**
     * Dibuja un Portaaviones (tamaño 4).
     * Característica principal: Cubierta de vuelo plana con líneas de pista y una "Isla" (torre de control).
     *
     * @param gc El GraphicsContext del Canvas.
     * @param x La coordenada X inicial para el dibujo.
     * @param y La coordenada Y inicial para el dibujo.
     * @param w El ancho total disponible para el barco.
     * @param h La altura total disponible para el barco.
     */
    ...
    /**
     * Dibuja un Submarino (tamaño 3).
     * Característica principal: Forma redondeada/cilíndrica y una vela (torre de control) central.
     * @param gc El GraphicsContext del Canvas.
     * @param x La coordenada X inicial para el dibujo.
     * @param y La coordenada Y inicial para el dibujo.
     * @param w El ancho total disponible para el barco.
    ...
    /**
     * Dibuja un Destructor (tamaño 2).
     * Característica principal: Forma más angular y proa afilada, con superestructura central y dos torretas.
     * @param gc El GraphicsContext del Canvas.
     * @param x La coordenada X inicial para el dibujo.
     * @param y La coordenada Y inicial para el dibujo.
     * @param w El ancho total disponible para el barco.
    ...
    /**
     * Dibuja una Fragata (tamaño 1, predeterminado).
     * Característica principal: Barco pequeño, rápido, con una cabina de mando y un cañón principal.
     * @param gc El GraphicsContext del Canvas.
     * @param x La coordenada X inicial para el dibujo.
     * @param y La coordenada Y inicial para el dibujo.
     * @param w El ancho total disponible para el barco.
    ...
    /**
     * Dibuja un pequeño detalle de torreta de cañón.
     * @param gc El GraphicsContext para dibujar.
     * @param cx La coordenada X central de la torreta.
     * @param cy La coordenada Y central de la torreta.
     */
